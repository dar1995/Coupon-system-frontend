...
import { addedGeneralCouponAction } from "../../../Redux/GeneralCouponsAppState";
function AddCoupon(): JSX.Element {
  ...
  const onSubmit = (data: CouponModel) => {
    ...
    return webApiService
      ...
      .then((res) => {
        ...
        dispatch(addedGeneralCouponAction(res.data));
        setOpen(true);
      })
      .catch((err) =>
        err?.response
  ...
  return (
    <div className="AddCoupon">
      <form
        action=""
        className="addCouponForm"
        onSubmit={handleSubmit(onSubmit)}
      >
        <div className="addCouponInputCon">
          <div className="addCouponInput1">
            <MyInput
              name="title"
              type="string"
